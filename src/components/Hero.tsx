...
export default function Hero() {
  ...
  return (
    <section className="relative">
      <div className="relative min-h-[560px] overflow-hidden pb-8 md:min-h-[600px] lg:min-h-[640px]">
        ...
        <div className="relative z-10 flex min-h-[560px] flex-col justify-center py-10 md:min-h-[600px] lg:min-h-[640px]">
          <div className="mx-auto w-full max-w-7xl px-4">
            <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1fr)_min(100%,20rem)] lg:gap-x-20 xl:gap-x-24">
              <div>
      ...
      <div className="relative z-10 -mt-16 mx-auto max-w-7xl px-4 pb-8">
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
          {quickActions.map((action) => {
            const className =
              "flex items-center gap-3 rounded-xl bg-white p-4 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-card-hover md:p-5";
            const inner = (
              <>
...
function ActionIcon({ type }: { type: string }) {
  const wrapper =
    "flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-brand-red/10 text-brand-red";
